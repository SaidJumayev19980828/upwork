...
//        UserEntity user = this.createUserFromJson(userJson);
    ...
    private UserEntity getUserEntityByEmail(String email) {
        ...
        if (!EntityUtils.validateEmail(email)) {
            UserApiResponse userApiResponse = UserApiResponse.createMessagesApiResponse(false, Collections.singletonList(ResponseStatus.INVALID_EMAIL));
        ...
        if (EntityUtils.isBlankOrNull(userEntity)) {
            UserApiResponse userApiResponse = UserApiResponse.createMessagesApiResponse(false, Collections.singletonList(ResponseStatus.EMAIL_NOT_EXIST));
    ...
    private UserApiResponse sendRecoveryMail(UserEntity userEntity) {
        ...
        try {
            ...
            throw new EntityValidationException("Could not send Email ", userApiResponse, HttpStatus.INTERNAL_SERVER_ERROR);
        }
