...
public class OrganizationController {
    ...
    @GetMapping(value = "products_features", produces = APPLICATION_JSON_UTF8_VALUE)
    ...
    @DeleteMapping(value = "image", produces = APPLICATION_JSON_UTF8_VALUE)
    ...
    @PostMapping(value = "tag", produces = APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<TagResponse> createOrganizationTag(@RequestHeader (value = "User-Token") String userToken,
                                         @RequestBody TagsDTO tagDTO) throws BusinessException {
        TagsEntity tag = categoryService.createOrgTag(tagDTO);
        return new ResponseEntity<TagResponse>(new TagResponse(tag.getId()),HttpStatus.OK);
    }
    ...
    @DeleteMapping(value = "tag", produces = APPLICATION_JSON_UTF8_VALUE)
    ...
    @PostMapping(value = "tag/link", produces = APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<String> createTagChildren(@RequestHeader (value = "User-Token") String userToken,
                                            @RequestBody TagsLinkDTO tagsLinks) throws BusinessException {
        categoryService.createTagEdges(tagsLinks);
        return new ResponseEntity<String>(new JSONObject("{\"Message\":\"Children created successfully\"}").toString(),HttpStatus.OK);
    }
    ...
    @DeleteMapping(value = "tag/link", produces = APPLICATION_JSON_UTF8_VALUE)
    public ResponseEntity<String> deleteTagChildren(@RequestHeader (value = "User-Token") String userToken,
                                            @RequestBody TagsLinkDTO tagsLinks) throws BusinessException {
        categoryService.deleteTagLink(tagsLinks);
        return new ResponseEntity<String>(new JSONObject("{\"Message\":\"Children removed from parent successfully\"}").toString(),HttpStatus.OK);
    }
