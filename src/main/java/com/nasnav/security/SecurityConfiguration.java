...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private  List<AuthPattern> permissions = Arrays.asList(
						...
						patternOf( "/product/images"				,HttpMethod.GET		, setOf(Roles.ORGANIZATION_ADMIN)),
						...
						patternOf( "/organization/tag"									, setOf(Roles.ORGANIZATION_ADMIN)),
						patternOf( "/organization/tags"									, setOf(Roles.ORGANIZATION_ADMIN)),
