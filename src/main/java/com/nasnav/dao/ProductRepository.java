...
//    List<ProductEntity> findByOrganizationIdOrderByPriceAsc(Long organizationId);
//    List<ProductEntity> findByOrganizationIdOrderByPriceDesc(Long organizationId);
...
//    List<ProductEntity> findByOrganizationIdAndCategoryIdOrderByPriceAsc(Long organizationId,Long categoryId);
//    List<ProductEntity> findByOrganizationIdAndCategoryIdOrderByPriceDesc(Long organizationId,Long categoryId);
