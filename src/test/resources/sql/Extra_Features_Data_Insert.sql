...
INSERT INTO public.extra_attributes(id, key_name, attribute_type, organization_id, icon) VALUES(11003, 'name_2', 'String', 99002, 'icon');
INSERT INTO public.extra_attributes(id, key_name, attribute_type, organization_id, icon) VALUES(11004, 'name_3', 'String', 99002, 'icon');
INSERT INTO public.extra_attributes( id, key_name, attribute_type, organization_id, icon)
    VALUES (11005, 'koko', 'Invisible', 99001, '/uploads/category/logo/logo1.jpg');
INSERT INTO public.extra_attributes( id, key_name, attribute_type, organization_id, icon)
    VALUES (11006, 'lobo', 'String', 99001, '/uploads/category/logo/logo1.jpg');
