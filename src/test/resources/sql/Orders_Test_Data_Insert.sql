...
INSERT INTO public.organizations(id, name, created_at, updated_at) VALUES (803, 'organization_2', now(), now());
...
INSERT INTO public.brands(id, category_id, name,created_at, updated_at, organization_id) VALUES (103, 202, 'brand_3', now(), now(), 801);
...
INSERT INTO public.shops(id, name, brand_id, created_at, updated_at, organization_id) VALUES (503, 'shop_3', 102, now(), now(), 801);
INSERT INTO public.shops(id, name, brand_id, created_at, updated_at, organization_id) VALUES (504, 'shop_4', 103, now(), now(), 803);
INSERT INTO public.shops(id, name, brand_id, created_at, updated_at, organization_id) VALUES (505, 'shop_5', 101, now(), now(), 803);
INSERT INTO public.shops(id, name, brand_id, created_at, updated_at, organization_id) VALUES (506, 'shop_6', 102, now(), now(), 802);
...
INSERT INTO public.users(id, email, created_at, updated_at, user_name, authentication_token, organization_id)
    VALUES (89, 'user2@nasnav.com',now(), now(), 'user2','456', 802);
INSERT INTO public.users(id, email, created_at, updated_at, user_name, authentication_token, organization_id)
    VALUES (90, 'user3@nasnav.com',now(), now(), 'user3','789', 803);
...
INSERT INTO public.employee_users(id, created_at, updated_at, email, organization_id, authentication_token, shop_id)
	VALUES (70, now(), now(), 'testuser4@nasnav.com', 801, '161718',  503);
INSERT INTO public.employee_users(id, created_at, updated_at, email, organization_id, authentication_token, shop_id)
	VALUES (71, now(), now(), 'testuser5@nasnav.com', 803, '192021',  504);
INSERT INTO public.employee_users(id, created_at, updated_at, email, organization_id, authentication_token, shop_id)
	VALUES (158, now(), now(), 'testuser3@nasnav.com', 802, '222324',  506);
...
insert into roles(id, name, created_at, updated_at, organization_id) values(4, 'ORGANIZATION_EMPLOYEE', now(), now(), 801);
insert into roles(id, name, created_at, updated_at, organization_id) values(5, 'STORE_EMPLOYEE', now(), now(), 801);
...
--inserting orders
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(33, 88, now(), now(), 801, 0, 502);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(37, 88, now(), now(), 802, 0, 501);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(38, 90, now(), now(), 802, 1, 501);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(39, 88, now(), now(), 801, 1, 501);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(40, 88, now(), now(), 801, 0, 503);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(41, 90, now(), now(), 801, 1, 502);
...
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(34, 89, now(), now(), 803, 0, 504);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(35, 89, now(), now(), 802, 0, 501);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(36, 90, now(), now(), 803, 1, 505);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(44, 89, now(), now(), 803, 1, 505);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(45, 89, now(), now(), 801, 0, 502);
insert into orders(id,user_id,created_at, updated_at, organization_id,status,shop_id) values(46, 90, now(), now(), 802, 1, 502);
