...
--insert orders
insert into public.orders(id,user_id,created_at, updated_at, organization_id,status,shop_id, payment_status) values(430033, 88, now(), now(), 99001, 1, 50001, 0);
...
INSERT INTO public.integration_mapping (mapping_type, local_value, remote_value, organization_id) VALUES(67007, '430033', 'UNR19-051602', 99001);
