...
INSERT INTO public.emp_user_tokens(id, token, update_time, user_id) VALUES (3, 'ssErf33', now(), 70);
...
insert into public.product_variants(id, "name" , product_id, barcode  ) values(310002, 'var' 	, 1001, 'ABCDEFG123');
