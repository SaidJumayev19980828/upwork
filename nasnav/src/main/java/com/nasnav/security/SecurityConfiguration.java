...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private  List<AuthPattern> permissions = asList(
						...
						patternOf( "/package/{packageId}"					,HttpMethod.PUT	, setOf(NASNAV_ADMIN) ),
						patternOf( "/package/{packageId}"					,HttpMethod.DELETE	, setOf(NASNAV_ADMIN) ),
						patternOf( "/package/complete-profile"					,HttpMethod.POST	, setOf(NASNAV_ADMIN) ),
