...
public class SecurityConfiguration {
	...
	private  List<AuthPattern> permissions = asList(
			...
			patternOf( "/user/info"),
			patternOf( "/user/create"											, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN, STORE_MANAGER) ),
			...
			patternOf( "/user/suspend"											, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			...
			patternOf( "/product/empty_collections"		,HttpMethod.GET		, setOf(ORGANIZATION_ADMIN, ORGANIZATION_MANAGER, MEETUSVR_ADMIN)),
			patternOf("/product/out-of-stock-products", HttpMethod.GET, setOf(ORGANIZATION_ADMIN, ORGANIZATION_MANAGER)),
			patternOf( "/admin/organization/domain"	   	,HttpMethod.GET		, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN) ),
			patternOf( "/admin/organization/domains"	   	,HttpMethod.GET		, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN) ),
			patternOf( "/admin/**"	   	 									, setOf(MEETUSVR_ADMIN) ),
			patternOf( "/files/**"							,HttpMethod.DELETE  , setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			patternOf( "/files/**"),
			patternOf( "/permission/**"					,setOf(MEETUSVR_ADMIN)),
			patternOf( "/roles/**"							,setOf(MEETUSVR_ADMIN)),
			patternOf( "/package/organizations/**"					, GET, setOf(MEETUSVR_ADMIN)),
			patternOf( "/package"					, POST, setOf(MEETUSVR_ADMIN)),
			patternOf( "/package/{packageId:\\d+}"			, PUT, setOf(MEETUSVR_ADMIN)),
			patternOf( "/package/{packageId:\\d+}"			, DELETE, setOf(MEETUSVR_ADMIN) ),
			patternOf( "/package/register"		, POST, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN, ORGANIZATION_MANAGER) ),
			patternOf( "/package/deregister"		, POST	, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN, ORGANIZATION_MANAGER) ),
			...
			patternOf( "/organization/themes/class"							, setOf(MEETUSVR_ADMIN)),
			patternOf( "/process/**"											, setOf(MEETUSVR_ADMIN)),
			...
			patternOf( "/organization/images_info"								, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			patternOf( "/organization/search/**"								, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			...
			patternOf("/subscription/package/**"						, HttpMethod.GET ,setOf(MEETUSVR_ADMIN)),
			...
			patternOf( "/integration/module/disable"							, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			patternOf( "/integration/module/enable"							, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			patternOf( "/integration/module/**"								, setOf(MEETUSVR_ADMIN)),
			patternOf( "/integration/param/**"									, setOf(MEETUSVR_ADMIN)),
			patternOf( "/integration/dictionary"								, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			patternOf( "/integration/errors"									, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN)),
			patternOf( "/integration/**"										, setOf(MEETUSVR_ADMIN))
			,patternOf( "/cart/checkout", POST ,getAllRoles()),
			patternOf( "/cart/{userId:\\d+}"		,GET						, setOf(ORGANIZATION_ADMIN, ORGANIZATION_MANAGER)),
			patternOf( "/cart/store-checkout/initiate"	 ,POST					, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN, ORGANIZATION_MANAGER,ORGANIZATION_EMPLOYEE, STORE_EMPLOYEE, STORE_MANAGER)),
			patternOf( "/cart/store-checkout/complete"	 ,POST					, setOf(MEETUSVR_ADMIN, ORGANIZATION_ADMIN, ORGANIZATION_MANAGER,ORGANIZATION_EMPLOYEE, STORE_EMPLOYEE, STORE_MANAGER)),
			...
			patternOf( "/bank/account"					,PUT						,  setOf(MEETUSVR_ADMIN)),
			patternOf( "/bank/account/setOpeningBalance",POST						,  setOf(MEETUSVR_ADMIN)),
			...
			patternOf( "/service/**", setOf(MEETUSVR_ADMIN)),
