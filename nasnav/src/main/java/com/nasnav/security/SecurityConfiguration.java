...
public class SecurityConfiguration {
	...
	private  List<AuthPattern> permissions = asList(
			...
			patternOf( "/package/organizations/**"					, GET, setOf(NASNAV_ADMIN)),
			patternOf( "/package"					, POST, setOf(NASNAV_ADMIN)),
			patternOf( "/package/{packageId:\\d+}"			, PUT, setOf(NASNAV_ADMIN)),
			patternOf( "/package/{packageId:\\d+}"			, DELETE, setOf(NASNAV_ADMIN) ),
			patternOf( "/package/register"		, POST, setOf(NASNAV_ADMIN, ORGANIZATION_ADMIN, ORGANIZATION_MANAGER) ),
			patternOf( "/package/deregister"		, POST	, setOf(NASNAV_ADMIN, ORGANIZATION_ADMIN, ORGANIZATION_MANAGER) ),
			...
			patternOf("/subscription/package/**"						, HttpMethod.GET ,setOf(NASNAV_ADMIN)),
			...
			patternOf( "/service/**", setOf(NASNAV_ADMIN)),
