...
public class VideoChatController {
    ...
    @GetMapping(value = "/get-sessions", produces = APPLICATION_JSON_VALUE)
    public List<BaseRepresentationObject> getOrgSessions(@RequestHeader(name = "User-Token") String userToken,
