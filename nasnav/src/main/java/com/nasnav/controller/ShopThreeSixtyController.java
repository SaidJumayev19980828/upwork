...
public class ShopThreeSixtyController {
    ...
    @Operation(description =  "Get information about shop 360 json data", summary = "getShop360Data")
    ...
    @Operation(description =  "Get information about shop 360 sections", summary = "getShop360Sections")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Get shop360s of specific shop", summary = "getShop360s")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "publish json data", summary = "publishJsonData")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Create/Update shop360", summary = "updateShop360")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Create/Update shop360 json data", summary = "updateShop360JsonData")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Create/Update shop360 products positions", summary = "updateShop360ProductPositions")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Get information about shop 360 products positions", summary = "getShop360ProductsPositions")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Create/Update shop360 sections", summary = "updateShop360Sections")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Search for products related to 360", summary = "get360sProducts")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "OK"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Delete shop 360 floors", summary = "delete360sFloors")
    ...
    @Operation(description =  "Delete shop 360 floor", summary = "delete360sFloor")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "Deleted"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Delete shop 360 section", summary = "delete360sSection")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "Deleted"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
    ...
    @Operation(description =  "Delete shop 360 scene", summary = "delete360sScene")
    @ApiResponses(value = { @ApiResponse(responseCode = " 200" ,description = "Deleted"),
            @ApiResponse(responseCode = " 406" ,description = "INVALID_PARAM")})
