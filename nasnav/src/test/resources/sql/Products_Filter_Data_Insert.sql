...
VALUES(630001, 'WELCOME', 99001, now() + INTERVAL '200 DAY', now() + INTERVAL '201 DAY', 1, 0, 'WELCOME2020', '{"applied_to_products":[1001,1002]}', '{}', 69, now());
INSERT INTO public.promotions
(id, identifier, organization_id, date_start, date_end, status, user_restricted, code, constrains, discount, created_by, created_on)
VALUES(630002, 'HI', 99001, now() - INTERVAL '2 DAY', now() + INTERVAL '2 DAY', 1, 0, 'GREEEEEED', '{"applied_to_tags":[22001,22001]}', '{"percentage":10}', 69, now());
INSERT INTO public.promotions
(id, identifier, organization_id, date_start, date_end, status, user_restricted, code, constrains, discount, created_by, created_on)
...
--inserting stocks
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(601, 502, 6, 99002, 600.00, 310001, 1, 5);
...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(603, 501, 4, 99002, 200.00, 310003, 1, 10);
...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(605, 502, 0, 99001, 700.00, 310009, 0, 20);
