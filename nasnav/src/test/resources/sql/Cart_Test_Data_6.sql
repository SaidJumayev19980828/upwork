...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency) values(604, 503, 6, 99001, 700.00, 310004, 1);
...
-- other stocks for variant 310002 in other shops
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency) values(607, 502, 8, 99001, 1200.0, 310002, 1);
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency) values(608, 503, 8, 99001, 1200.0, 310002, 1);

-- other stocks for variant 310004 in other shops 
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency) values(609, 502, 6, 99001, 800.00, 310004, 1);
