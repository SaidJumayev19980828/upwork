...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(604, 502, 100, 99001, 700.00, 310004, 1, 10);
...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(606, 502, 100, 99001, 700.00, 310010, 1, 15);
...
INSERT INTO public.organization_shipping_service values('BOSTA_LEVIS', 99001,
                                                        '{"name": "Bosta","type": "long","value": "1","name2": "Bosta2","type2": "long","value2": "1","name3": "Bosta3","type3": "long","CAIRO_PRICE": "100" }', 99001);
...
VALUES('{"warehouse_id":501}', 'WAREHOUSE', 99001, null);

INSERT INTO public.organiztion_cart_optimization
(optimization_parameters, optimization_strategy, organization_id, shipping_service_id)
VALUES('{"warehouse_id":501}', 'WAREHOUSE', 99001, 'BOSTA_LEVIS');

INSERT INTO public.user_otp (otp, id, user_id, created_at, type) VALUES ('123456', 1, 88, now(), 'CHECKOUT');
