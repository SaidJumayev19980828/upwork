...
INSERT INTO public.settings(
	id, setting_name, setting_value, organization_id)
	VALUES (1, 'ORG_EMAIL', 'org1@yahoo.com', 99001);

INSERT INTO public.settings(
    	id, setting_name, setting_value, organization_id)
    	VALUES (2, 'ORG_EMAIL', 'org21@yahoo.com', 99002);
...
INSERT INTO public.contact_us(
	id, customer_name, customer_email, message, created_at, organization_id)
	VALUES (1, 'customer_name', 'customer_email@yahoo.com', 'message', now(), 99001);