...
-- insert collection
INSERT INTO public.products(id, name, brand_id, category_id, organization_id, created_at, updated_at, type) VALUES (1009, 'product_9',102, 202, 99002, now(), now(), 2);
...
-- insert collections variants
insert into product_collections (product_id,variant_id)values (1009, 310010);
