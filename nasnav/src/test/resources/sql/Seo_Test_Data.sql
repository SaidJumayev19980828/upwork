...
-- insert seo keywords
insert into seo_keywords(id, entity_id, type_id, organization_id, keyword) values(333001, 99002, 0, 99002, 'Search bot cookie!');
insert into seo_keywords(id, entity_id, type_id, organization_id, keyword) values(333002, 1002, 1, 99002, 'Search bot choco!');
insert into seo_keywords(id, entity_id, type_id, organization_id, keyword) values(333003, 5001, 2, 99001, 'Search bot konafa with mango!');
insert into seo_keywords(id, entity_id, type_id, organization_id, keyword) values(333004, 5002, 2, 99002, 'Search bot notella!');