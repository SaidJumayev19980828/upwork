...
insert into public.product_variants(id, "name" , product_id ,barcode, p_name, description, feature_spec) values(310003, 'var1', 200003, 'TT232222', 'u_shoe', 'old desc', '{}');
insert into public.product_variants(id, "name" , product_id ,barcode, p_name, description, feature_spec) values(310004, 'var2', 200003, 'BB232222', 'n_shoe', 'old desc 2', '{}');


-- stocks for variants
insert into public.stocks(id, shop_id  , variant_id , quantity , price,  organization_id)
values (400001, 100004, 310003, 1 , 1000 , 99001);
insert into public.stocks(id, shop_id , variant_id , quantity , price,  organization_id)
values (400002, 100004,310004, 20 , 122, 99001);
...
INSERT INTO public.integration_mapping (mapping_type, local_value, remote_value, organization_id)
	VALUES(67001, '310003', '5', 99001) ;
INSERT INTO public.integration_mapping (mapping_type, local_value, remote_value, organization_id)
	VALUES(67001, '310004', '6', 99001) ;
