...
VALUES (
           ...
           CONCAT(
                   ...
                   '"PARENT_REGISTRATION":{"value":0.0,"valid_from":"', DATE(NOW() -  INTERVAL '5' DAY), '","valid_to":"', DATE(NOW() - INTERVAL '3' DAY), '"},',
                   '"CHILD_REGISTRATION":{"value":0.0,"valid_from":"', DATE(NOW() - INTERVAL '5' DAY), '","valid_to":"', DATE(NOW() - INTERVAL '3' DAY), '"}}'
               ),
           'USER',
           NOW()
       );
