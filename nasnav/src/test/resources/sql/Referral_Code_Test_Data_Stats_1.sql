...
INSERT INTO public.referral_transactions(
    id, amount, created_at, referral_transaction_type, referral_wallet_id, user_id, order_id, referral_type)
VALUES (1000001, 20.0, now(), 'ORDER_WITHDRAWAL', 500, 89, 330035, 'USER');
