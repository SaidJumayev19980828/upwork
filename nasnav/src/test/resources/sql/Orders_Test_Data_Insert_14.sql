...
insert into public.product_variants(id, "name" , product_id, removed, feature_spec ) values(310001, 'var' 	, 1001, 1, '{"235": "white"}');
insert into public.product_variants(id, "name" , product_id , feature_spec) values(310002, 'var' 	, 1002, '{"234": "45"}');
...
-- insert order items
INSERT INTO public.baskets(order_id, stock_id, quantity, price, currency, item_data)
VALUES(330031, 601, 14, 60.0, 1,'{"name":"original", "variant_features" : {"new_feature" :"shiny"}}');
INSERT INTO public.baskets(order_id, stock_id, quantity, price, currency, item_data)
VALUES(330032, 602, 2, 70.0, 1, '{"name":"so original", "variant_features" : {"new_feature" :"brownie"}}');
