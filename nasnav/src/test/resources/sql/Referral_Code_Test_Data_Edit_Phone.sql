...
INSERT INTO public.referral_codes(id, referral_code, org_id, user_id, settings_id, phone_number, status, created_at, accept_token)
VALUES (500, 'abcdfg', 99001, 88, 200, '012432235342',2, now(), 'qwerty');

INSERT INTO public.referral_codes(id, referral_code, parent_referral_code, org_id, user_id, settings_id, phone_number,status, created_at, accept_token)
VALUES (501, 'asdfgh', 'abcdfg', 99001, 89, 200, '01234554319', 1, now(), 'rtyuiu');
