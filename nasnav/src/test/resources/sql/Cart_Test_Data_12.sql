...
INSERT INTO public.products(id, name, brand_id, category_id, organization_id, created_at, updated_at, removed) VALUES (1008, 'product_8',102, 202, 99002, now(), now(), 1);
...
insert into public.product_variants(id, "name" , product_id, removed ) values(310003, 'var' 	, 1001, 1);
...
INSERT INTO public.cart_items (stock_id, cover_image, variant_features, quantity, user_id) VALUES(603, '99001/cover_img.jpg', '{"Color":"Yellow"}', 1, 88);
