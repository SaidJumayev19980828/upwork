...
VALUES (1, 'smtp_id', 'abc', 99001, 0);

INSERT INTO public.settings(id, setting_name, setting_value, organization_id, type)
VALUES (2, 'smtp_key', 'def', 99001, 0);

INSERT INTO public.settings(id, setting_name, setting_value, organization_id, type)
VALUES (3, 'ORG_EMAIL', 'organization_1@nasnav.com', 99001, 0);
...
INSERT INTO public.users(id, email,  user_name, authentication_token, organization_id, user_status)
    VALUES (88, 'hussien.assem@nasnav.com','user1','123', 99001, 201);
...
-- insert cart
INSERT INTO public.cart_items (id, stock_id, cover_image, variant_features, quantity, user_id, is_wishlist, additional_data)
 VALUES(111602, 602, '99001/img2.jpg', '{"Color":"Blue"}', 2, 88, 1, 'out_of_stock');
