...
VALUES(630001, 'WELCOME', 99001, now() + INTERVAL '200 DAY', now() + INTERVAL '201 DAY', 1, 0, 'abcd', '{}', '{}', 69, now(), 'pro_name_1', 'pro_desc_1', 'pro_banner_1', 'pro_cover_1', 0);
...
VALUES (
           ...
           CONCAT(
                   ...
                   '","products":[1001,1002,1003],"cashbackValue": 20.0, "discountValue":20.0}'
           ),
           'INFLUENCER',
           NOW()
       );
...
INSERT INTO public.referral_codes(id, referral_code, org_id, user_id, settings_id, status, referral_type, created_at, accept_token)
VALUES (501, 'asdfgh', 99001, 1001, 201, 2, 'INFLUENCER', now(), 'qwerty');

INSERT INTO public.influencer_referral(
    id, first_name, last_name, user_name, password, referral_code_id, referral_settings_id, referral_wallet_id)
VALUES (1000, 'mohamed', 'shaker', 'mohamedshaker', '$2a$10$cPMfjHeqJqoKJ/L8jlTYVu34ssP/jpKEPrz1cN8lXSSWogma8m97S', 500, 200, 500);
INSERT INTO public.influencer_referral(
    id, first_name, last_name, user_name, password, referral_code_id, referral_settings_id, referral_wallet_id)
VALUES (1001, 'mohamed2', 'shaker2', 'mohamedshaker2', '$2a$10$cPMfjHeqJqoKJ/L8jlTYVu34ssP/jpKEPrz1cN8lXSSWogma8m97S', 501, 201, 501);

-- inserting a wallet for user for referral Codes
INSERT INTO public.referral_wallet(id, balance, version, user_id, referral_type) VALUES (500, 200.00, 1, 1000, 'INFLUENCER');
INSERT INTO public.referral_wallet(id, balance, version, user_id, referral_type) VALUES (501, 300.00, 1, 1001, 'INFLUENCER');
