...
--inserting orders
insert into public.orders(id,user_id,created_at, updated_at, organization_id,status,shop_id, meta_order_id, sub_total, discounts, applied_influencer_referral_code) values(330033, 89, now(), now(), 99001, 2, 502, 310033,200.00, 20.00,'utiire');
