...
INSERT INTO public.products(id, name, brand_id, category_id, organization_id, created_at, updated_at, removed) VALUES (1002, 'product_2',101, 201, 99002, now(), now(), 1);
...
insert into Tags(id, name, alias, category_id, organization_id, metadata, graph_id) values(5001,'tag_1', 'tag_1', null, 99001, '', 99001);
insert into Tags(id, name, alias, category_id, organization_id, metadata, graph_id) values(5002,'tag_2', 'tag_2', null, 99001, '', 99001);
insert into Tags(id, name, alias, category_id, organization_id, metadata, graph_id) values(5003,'tag_3', 'tag_3', 203, 99001, '', 99001);
...
INSERT INTO public.tag_graph_nodes (id, tag_id,priority) VALUES(50011,5001,23);
INSERT INTO public.tag_graph_nodes (id, tag_id,priority) VALUES(50012,5002,24);
INSERT INTO public.tag_graph_nodes (id, tag_id,priority) VALUES(50013,5003,43);
INSERT INTO public.tag_graph_nodes (id, tag_id,priority) VALUES(50014,5004,40);
INSERT INTO public.tag_graph_nodes (id, tag_id,priority) VALUES(50015,5005,32);
INSERT INTO public.tag_graph_nodes (id, tag_id,priority) VALUES(50016,5006,56);
