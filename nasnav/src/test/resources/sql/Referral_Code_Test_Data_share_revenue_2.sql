...
VALUES (
           ...
           CONCAT(
                   ...
                   '"SHARE_REVENUE_PERCENTAGE":{"value":0.04,"valid_from":"', DATE(NOW() - INTERVAL '3' DAY), '","valid_to":"', DATE(NOW() - INTERVAL '3' DAY), '"}}'
           ),
           'USER',
           NOW()
       );
...
VALUES (501, 'asdfgh', 'abcdfg', 99001, 89, 201, 2, 'USER', now(), 'rtyuiu');