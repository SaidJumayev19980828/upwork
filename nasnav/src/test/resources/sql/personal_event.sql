...
INSERT INTO public.personal_event(
	id, created_at, starts_at, ends_at, canceled, name, user_id, employee_id)
	VALUES (99, now(),  now()+ interval '1 day' ,now()+ interval '2 day', false, 'test0', 88, null),
		   (100, now(),  now() - interval '2 day' ,now() - interval '1 day', false, 'test', 88, null),
	       (101, now(), now()+ interval '1 day' , now()+ interval '2 day', false , 'test2', null , 68);

INSERT INTO public.event_invitees(
	id, event_id, user_id, employee_id, external_user)
	VALUES (1, 99,89, null, null),
	 (2, 99 ,null, null, 'tesst@gmail.com')