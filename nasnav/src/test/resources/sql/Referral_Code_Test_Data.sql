...
--inserting orders
insert into public.orders(id,user_id,created_at, updated_at, organization_id,status,shop_id, meta_order_id, sub_total, applied_referral_code) values(330033, 88, now(), now(), 99001, 2, 502, 310033,200.00,'abcdfg');
...
INSERT INTO public.referral_wallet(id, balance, version, user_id) VALUES (500, 20, 1, 89);

-- insert referral code that is valid
INSERT INTO public.referral_codes(id, referral_code, start_date, end_date, org_id, user_id, constraints, created_by, status, created_at, accept_token)
VALUES (500, 'abcdfg', now(), now() + INTERVAL '1 day' , 99001, 89, '{"REFERRAL_ACCEPT_REVENUE":20.0,"ORDER_DISCOUNT_PERCENTAGE":0.03,"SHARE_REVENUE_PERCENTAGE":0.04}', 68, 2, now(), '12345');
