...
INSERT INTO public.areas(id, "name", city_id)VALUES(4, 'Rehab', 1);
INSERT INTO public.sub_areas(id, area_id, organization_id, "name")
values(676701, 1, 99001, 'Supported sub-area');
INSERT INTO public.sub_areas(id, area_id, organization_id, "name")
values(676702, 1, 99001, 'Unsupported sub-area');

INSERT INTO public.addresses(id, address_line_1, area_id, phone_number ,sub_area_id) values(12300001, 'supported address', 1, '01111234567', 676701);
INSERT INTO public.addresses(id, address_line_1, area_id, phone_number ,sub_area_id) values(12300002, 'unsupported address', 1, '01111234567', 676702);
INSERT INTO public.addresses(id, address_line_1, area_id, phone_number ,sub_area_id) values(12300003, 'supported address', 1, '01222222222', 676701);
...
INSERT INTO public.User_addresses(id, user_id, address_id, principal) values(12300002, 88, 12300002, false);
INSERT INTO public.User_addresses(id, user_id, address_id, principal) values(12300003, 89, 12300003, false);
...
INSERT INTO public.organization_shipping_service values('VAR_FEE_SELECTED_SUBAREAS_MIN_ORDER', 99001, '{
        "SUBAREAS_SHIPPING_FEES": {
            "676701": 20
        },
        "MIN_ORDER_VALUE": 100,
        "INVALID_ORDER_MSG" : "Pay More than %s or no delivery!!!",
        "ETA_MINUTES_MIN": 60,
        "ETA_MINUTES_MAX": 90
      }', 99001);
