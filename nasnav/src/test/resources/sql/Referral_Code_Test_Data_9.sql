...
INSERT INTO public.referral_codes(id, referral_code, org_id, user_id, settings_id, status, referral_type, created_at, accept_token, PHONE_NUMBER)
VALUES (500, 'abcdfg', 99001, 88, 200, 2, 'USER', now(), 'qwerty', '01234567891');
