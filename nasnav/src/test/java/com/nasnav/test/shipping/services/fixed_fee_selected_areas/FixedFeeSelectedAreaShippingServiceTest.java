package com.nasnav.test.shipping.services.fixed_fee_selected_areas;
...
@NotThreadSafe
@Sql(executionPhase=BEFORE_TEST_METHOD,  scripts={"/sql/Shipping_Test_Data_13.sql"})
@Sql(executionPhase=AFTER_TEST_METHOD, scripts={"/sql/database_cleanup.sql"})
public class FixedFeeSelectedAreaShippingServiceTest extends AbstractTestWithTempBaseDir {
    ...
    @Test
    public void testGetOfferAreaOutOfService() {
        ShippingService service =
                shippingServiceFactory
                        .getShippingService(SERVICE_ID, createServiceParams())
                        .get();
        ...
        ShippingOffer offer = service.createShippingOffer(details).blockOptional().get();
        assertEquals(DEFAULT_ERR_AREA_NOT_SUPPORTED, offer.getMessage());
    }
