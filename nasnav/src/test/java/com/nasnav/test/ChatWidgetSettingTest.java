...
public class ChatWidgetSettingTest extends AbstractTestWithTempBaseDir {
    ...
    public void getUnPublishedChatWidgetSettingsForOrg() {
        HttpEntity request = getHttpEntity("131415");
        ResponseEntity<ChatWidgetSettingResponse>  result = template.exchange("/chat-widget-setting/get-unpublished?org_id=99001",GET,request, ChatWidgetSettingResponse.class);
