...
public class StripeSubscriptionTest extends AbstractTestWithTempBaseDir {
    ...
    public void stripeCreateSubscriptionNotRegisteredPackage() {
        ...
        ResponseEntity<StripeSubscriptionDTO> response = template.postForEntity("/subscription/stripe/createSubscription", json, StripeSubscriptionDTO.class);
...
//
//        HttpEntity<?> json = getHttpEntity("", "abcdefg");
//        ResponseEntity<StripeSubscriptionPendingDTO> response = template.postForEntity("/subscription/stripe/createSubscription", json, StripeSubscriptionPendingDTO.class);
