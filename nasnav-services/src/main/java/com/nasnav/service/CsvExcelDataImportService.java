...
public interface CsvExcelDataImportService {
	...
	Map<String,String> ORDER_DATA_TO_COLUMN_MAPPING = ImmutableMap.<String, String>builder()
			...
			.put("shippingAddress.flatNumber", "flatNumber")
			.put("shippingAddress.buildingNumber", "buildingNumber")
			.put("shippingAddress.phoneNumber", "phoneNumber")
			.put("shippingAddress.area", "area")
			.put("shippingAddress.city", "city")
			.put("shippingAddress.country", "country")
			.put("shippingAddress.subArea", "subArea")
			.put("shippingAddress.addressLine1", "addressLine1")
			.put("shippingAddress.addressLine2", "addressLine2")
		.build();
