...
public interface ServiceMapper {
    ...
    OrganizationServicesEntity dtoToOrg(OrganizationServicesDto dto);
    OrganizationServicesDto orgToDto(OrganizationServicesEntity org);
    ...
    default List<OrganizationServicesDto> orgToBeansWithoutList(List<OrganizationServicesEntity> entities){
        if(entities == null) return new LinkedList<>();
        List<OrganizationServicesDto> beans = new LinkedList<>();
        for (OrganizationServicesEntity entity : entities){
            beans.add(this.orgToDto(entity));
        }
        return beans;
    }
}
