...
@RestController
@RequestMapping(LoyaltyPointV2Controller.API_PATH)
@Tag(name = "Loyalty Point Controller")
@CrossOrigin("*")
public class LoyaltyPointV2Controller {
    static final String API_PATH = YeshteryConstants.API_PATH +"/loyalty/v2";
