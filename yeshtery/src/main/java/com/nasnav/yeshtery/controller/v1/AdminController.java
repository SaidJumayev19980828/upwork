...
public class AdminController {
    ...
    public OrganizationResponse createOrganization(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public CategoryResponse createCategory(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestBody CategoryDTO categoryJson) {
    	return categoryService.addOrUpdateCategory(categoryJson);
	}
	
	@PostMapping(value = "tag/category", consumes = APPLICATION_JSON_VALUE)
	public void setTagsListCategory(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestBody UpdateTagsCategoryDTO updateDto) {
		categoryService.setTagsListCategory(updateDto);
	}

	@PostMapping(value = "product/category", consumes = APPLICATION_JSON_VALUE)
	public void setProductListCategory(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public CategoryResponse deleteCategory(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
    ...
    public List<ThemeClassDTO> listThemeClasses(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken) {
        return themeService.listThemeClasses();
    }

    @GetMapping(value = "themes", produces = APPLICATION_JSON_VALUE)
    public List<ThemeDTO> listThemes(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public ThemeClassResponse updateThemeClass(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public ThemeResponse updateTheme(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public void deleteThemeClass(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestParam Integer id) throws BusinessException {
		themeService.deleteThemeClass(id);
	}

	@DeleteMapping(value = "themes")
	public void deleteTheme(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestParam String id) throws BusinessException {
		themeService.deleteTheme(id);
	}

	@PostMapping(value = "country", consumes = APPLICATION_JSON_VALUE)
	public void addCountry(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestBody CountryInfoDTO dto) {
		addressService.addCountry(dto);
	}

	@PostMapping(value = "country/bulk", consumes = APPLICATION_JSON_VALUE)
	public void addCountries(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestBody List<CountryDTO> dto) {
		addressService.addCountries(dto);
	}

	@DeleteMapping(value = "country")
	public void removeCountry(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public void updateDomain(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestBody DomainUpdateDTO dto) {
		domainService.updateDomain(dto);
	}

	@PostMapping(value = "cache/invalidate")
	public void invalidateAllCaches(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken) {
		adminService.invalidateCaches();
	}

	@GetMapping(value = "organization/domain", produces = TEXT_PLAIN_VALUE )
	public String getOrgDomain(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestParam Long id) {
	...
	public List<DomainUpdateDTO> getOrgDomains(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken, @RequestParam("org_id") Long id) {
		return domainService.getOrganizationDomains(id);
	}

	@DeleteMapping(value = "organization/domain")
	public void deleteOrgDomain(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
								@RequestParam Long id,
	...
	public Mono<Void> deleteSearchIndices(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken) {
		return searchService.deleteAllIndices();
	}

	@PostMapping(value = "priority/brands", consumes = APPLICATION_JSON_VALUE)
	public void bulkUpdateBrandsPriority(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
	...
	public ApiLogsResponse getApiCalls(@RequestHeader(value = TOKEN_HEADER, required = false) String userToken,
