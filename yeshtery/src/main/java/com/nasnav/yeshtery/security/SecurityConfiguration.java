...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private  List<AuthPattern> permissions = asList(
            ...
            ,patternOf( "/v1/order"						  ,HttpMethod.DELETE	, setOf(ORGANIZATION_ADMIN, ORGANIZATION_MANAGER))
            ,patternOf( "/v1/order/confirm"				  ,HttpMethod.POST	    , setOf(ORGANIZATION_MANAGER, STORE_MANAGER))
            ,patternOf( "/v1/order/reject"					  ,HttpMethod.POST	    , setOf(ORGANIZATION_MANAGER, STORE_MANAGER))
            ,patternOf( "/v1/order/cancel"					  ,HttpMethod.POST	    , setOf(CUSTOMER))
            ,patternOf( "/v1/order/meta_order/list/user"	  ,HttpMethod.GET		, setOf(CUSTOMER))
            ,patternOf( "/v1/order/track_info"				  ,HttpMethod.GET		, setOf(CUSTOMER))
            ,patternOf( "/v1/order/return/reject"			  ,HttpMethod.POST	    , setOf(ORGANIZATION_MANAGER))
            ,patternOf( "/v1/order/return/confirm"			  ,HttpMethod.POST	    , setOf(ORGANIZATION_MANAGER))
            ,patternOf( "/v1/order/return/received_item"	  ,HttpMethod.POST	    , setOf(ORGANIZATION_MANAGER, STORE_MANAGER))
            ,patternOf( "/v1/order/return"					  ,HttpMethod.POST	    , setOf(CUSTOMER))
            ,patternOf( "/v1/order/return/requests"		  ,HttpMethod.GET		, setOf(ORGANIZATION_ADMIN, STORE_MANAGER))
            ,patternOf( "/v1/order/return/request"			  ,HttpMethod.GET		, setOf(ORGANIZATION_ADMIN, STORE_MANAGER))
            ,patternOf( "/v1/order/status/update"			  ,HttpMethod.POST	    , setOf(ORGANIZATION_ADMIN, ORGANIZATION_MANAGER, STORE_MANAGER))
