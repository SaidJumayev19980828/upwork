...
@Data
@Schema(name = "Recommendation Selling data")
@JsonPropertyOrder({"product_id", "tag_id", "product_name", "total_count"})
@EqualsAndHashCode(callSuper=false)
public class RecommendationSellingJsonDTO  extends BaseJsonDTO {
