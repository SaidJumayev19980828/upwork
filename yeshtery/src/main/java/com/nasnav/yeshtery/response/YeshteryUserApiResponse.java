...
@AllArgsConstructor
@NoArgsConstructor
public class YeshteryUserApiResponse {
    ...
    public YeshteryUserApiResponse(Long entityId, String token) {
        this.entityId = entityId;
        this.token = token;
    }

    public YeshteryUserApiResponse(List<ResponseStatus> statuses) {
        this.status = statuses;
    }

    public YeshteryUserApiResponse(Long entityId) {
        this.entityId = entityId;
    }

    public YeshteryUserApiResponse(Cookie cookie) {
        this.cookie = cookie;
    }
}
