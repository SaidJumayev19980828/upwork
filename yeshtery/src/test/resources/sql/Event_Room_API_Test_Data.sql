...
INSERT INTO public.users(id, email,  user_name, authentication_token, organization_id)
VALUES (83, 'user83@nasnav.com','user3','user83', 99003);
...
INSERT INTO public.events(id,influencer_id,created_at,starts_at,ends_at,organization_id,visible,name,description,status)
values(51,100,now(),CURRENT_DATE + INTERVAL '1 day',CURRENT_DATE + INTERVAL '2 day',99001,false,'name51','desc',0);
INSERT INTO public.events(id,influencer_id,created_at,starts_at,ends_at,organization_id,visible,name,description,status)
values(52,101,now(),CURRENT_DATE + INTERVAL '1 day',CURRENT_DATE + INTERVAL '2 day',99001,false,'name52','desc',0);
INSERT INTO public.events(id,influencer_id,created_at,starts_at,ends_at,organization_id,visible,name,description,status)
values(53,null,now(),CURRENT_DATE + INTERVAL '1 day',CURRENT_DATE + INTERVAL '2 day',99002,false,'name53','desc',0);
INSERT INTO public.events(id,influencer_id,created_at,starts_at,ends_at,organization_id,visible,name,description,status) 
values(54,null,now(),CURRENT_DATE + INTERVAL '1 day',CURRENT_DATE + INTERVAL '2 day',99003,false,'name54','desc',0);
...
INSERT INTO public.room_templates(id, event_id, scene_id, data) VALUES (504, 54, 'anything504', '{"property504": "value504"}');
