...
--inserting stocks
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency) values(601, 502, 6, 99001, 600.00, 310001, 1);
...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(604, 502, 6, 99001, 700.00, 310004, 1, 10);
...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id, currency, discount) values(606, 502, 10, 99001, 700.00, 310010, 1, 15);
...
INSERT INTO public.promotions
(id, identifier, organization_id, date_start, date_end, status, user_restricted, code, constrains, discount, created_by, created_on, usage_limiter_count)
VALUES(630003, 'BYE', 99001, now() - INTERVAL '2 DAY', now() + INTERVAL '2 DAY', 1, 0, 'MORE_GREEEEEEED', '{"cart_amount_min":0, "amount_max":20000}', '{"percentage":10.99}', 69, now(),7);

INSERT INTO public.promotions
(id, identifier, organization_id, date_start, date_end, status, user_restricted, code, constrains, discount, created_by, created_on, usage_limiter_count)
VALUES(630004, 'BYE BYE', 99001, now() - INTERVAL '2 DAY', now() + INTERVAL '2 DAY', 1, 0, 'GREEEEEED_HEART', '{"cart_amount_min":0, "amount_max":20000}', '{"amount":100.55}', 69, now(),3);

INSERT INTO public.promotions
(id, identifier, organization_id, date_start, date_end, status, user_restricted, code, constrains, discount, created_by, created_on, usage_limiter_count)
VALUES(630005, 'SCAM', 99001, now() - INTERVAL '2 DAY', now() + INTERVAL '2 DAY', 1, 0, 'SCAM_GREEEEEEED', '{"cart_amount_min":10000 }', '{"percentage":10.99}', 69, now(),7);

INSERT INTO public.promotions
(id, identifier, organization_id, date_start, date_end, status, user_restricted, code, constrains, discount, created_by, created_on, usage_limiter_count)
VALUES(630006, 'DISAPPOINTMENT', 99001, now() - INTERVAL '2 DAY', now() + INTERVAL '2 DAY', 1, 0, 'kafa', '{"cart_amount_min":0, "discount_value_max":10 }', '{"percentage":10.99}', 69, now(),5);
