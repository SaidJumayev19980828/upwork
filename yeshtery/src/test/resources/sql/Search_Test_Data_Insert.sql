...
INSERT INTO public.user_tokens(id, token, update_time, employee_user_id, user_id) VALUES (100001, 'a', now(), 68, null);
...
INSERT INTO public.products(id, name, p_name, brand_id, category_id, organization_id, created_at, updated_at, product_type) VALUES (1006, 'product_6', 'product-six',102, 201, 99001, now(), now(), 2);
...
insert into public.stocks(id, shop_id, quantity,  organization_id, price, variant_id) values(609, 502, 6, 99001, 700.0, 310006);
