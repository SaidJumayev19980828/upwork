...
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88001, 'COD', 'uid', now(), 10.50, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88002, 'COD', 'uid', now(), 20.00, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88003, 'MCARD:MISR', 'uid', now(), 25.00, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88004, 'MCARD:MISR', 'uid', now(), 25.00, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88005, 'UPG:CIB:RASPORT', 'uid', now(), 30.00, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88006, 'COD', 'uid', now(), 50.00, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88007, 'COD', 'uid', now(), 60.00, 1, 88);
INSERT INTO public.payments (id, operator, uid, executed, amount, currency, user_id) VALUES (88008, 'MCARD:CIB:RASPORT', 'uid', now(), 60.00, 1, 88);
...
insert into public.orders(id, user_id,created_at, updated_at, organization_id,status,shop_id, meta_order_id, payment_id, total) values(330037, 88, '2022-05-07', now(), 99001, 5, 502, 310033, 88002, 1200.00);
...
insert into public.orders(id, user_id,created_at, updated_at, organization_id,status,shop_id, meta_order_id, payment_id, total) values(330041, 90, '2022-05-10', now(), 99001, 1, 502, 310041, 88005, 800.00);
...
insert into public.orders(id, user_id,created_at, updated_at, organization_id,status,shop_id, meta_order_id, payment_id, total) values(330045, 89, '2022-05-30', now(), 99001, 0, 502, 310045, 88007, 500.00);
...
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55001, 330033, 'BOSTA_LEVIS', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55002, 330037, 'BOSTA_LEVIS', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55003, 330039, 'PICKUP', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55004, 330040, 'PICKUP', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55005, 330041, 'BOSTA_LEVIS', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55006, 330042, 'PARTIAL_PICKUP', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55007, 330045, 'PARTIAL_PICKUP', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55008, 330047, 'PARTIAL_PICKUP', 20);
INSERT INTO public.shipment (id, sub_order_id, shipping_service_id, status) VALUES (55009, 330049, 'MULTIPLE_PICKUP', 20);