...
public class AvailabilityTest {
    ...
    public void createAvailabilitiesTest(){
        ...
        ResponseEntity<Void> response = template.postForEntity("/v1/availability", json, Void.class);
        ...
        ResponseEntity<Void> response2 = template.postForEntity("/v1/availability?force=true", json2, Void.class);
    ...
    public void shiftAvailability(){
        ...
        HttpEntity<?> json = getHttpEntity(requestBody,"abcdefg");
        ResponseEntity<Void> response = template.postForEntity("/v1/availability/shift/10", json, Void.class);
        assertEquals(200, response.getStatusCode().value());
