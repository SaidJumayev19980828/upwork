...
public class YeshteryUserRegistrationTest {
    ...
    public void unsuspendUserNotActivatedAccount() {
        HttpEntity req = getHttpEntity("101112");
        ResponseEntity<String> res = template.postForEntity(API_PATH+"/user/suspend?user_id=88004&suspend=false", req, String.class);
    ...
    public void userSubscribeTest(){
        ResponseEntity<String> response =
                template.exchange(API_PATH+"/user/subscribe?email=email@nasnav.com&org_id=99001", HttpMethod.POST, null, String.class);
    ...
    public void recoverEmployeeUser() {
        ...
        ResponseEntity<String> res = template.postForEntity(API_PATH+"/user/recover", request, String.class);
        assertEquals(200, res.getStatusCodeValue());
